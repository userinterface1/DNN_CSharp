namespace Deep_Learning_DNN
{
    internal class Program
    {
        ...
        static void backpropagation()
        {
            ...
            float update_w5 = w5 - learning_rate * totaldw5;

            float z3dw6 = h2;
            float totaldw6 = totaldoutput1 * o1dz3 * z3dw6;
            float update_w6 = w6 - learning_rate * totaldw6;
            ...
            float update_w7 = w7 - learning_rate * totaldw7;

            float z4dw8 = h2;

            float totaldw8 = totaldoutput2 * o2dz3 * z4dw8;
            float update_w8 = w8 - learning_rate * totaldw8;
            ...
            float update_w1 = w1 - learning_rate * totaldw1;

            float z1dw2 = input2;
            float totaldw2 = totaldh1 * h1dz1 * z1dw2;
            float update_w2 = w2 - learning_rate * totaldw2;

            float h2dz2 = h2 * (1 - h2);
            float z2dw3 = input1;
            float totaldw3 = totaldh2 * h2dz2 * z2dw3;
            float update_w3 = w3 - learning_rate * totaldw3;

            float z2dw4 = output2;
            float totaldw4 = totaldh2 * h2dz2 * z2dw4;
            float update_w4 = w4 - learning_rate * totaldw4;
        ...
        static void Main(string[] args)
        {
            ...
            if (yorn == "y")
            {
                ...
                target1 = float.Parse(Console.ReadLine());
                Console.Write("Target 2 : ");
                target2 = float.Parse(Console.ReadLine());
